...
@Service
class PasswordResetSuccessfullyPayloadConstructor @Autowired constructor(
    ...
    override fun getNotificationType() = NotificationEventType.PASSWORD_RESET_SUCCESSFULLY
}