...
abstract class BaseTestConfig {
    ...
    companion object {
        private val postgresContainer = PostgreSQLContainer<Nothing>(DockerImageName.parse("postgres:14"))
            .apply {
        ...
        fun registerProperties(registry: DynamicPropertyRegistry) {
            ...
            registry.add("api-config.openApis", Supplier { listOf("/login", "/generate-otp", "/verify-otp") })
        }
